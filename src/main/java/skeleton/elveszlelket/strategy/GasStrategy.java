 ...
 * amikor egy diák használ egy camembertet, ami befolyásolhatja a szobában lévő gázt.
 * Ez a stratégia ellenőrzi, hogy egy feltétel (itt példaként a "camembert zárt-e?")
 * teljesül-e, és ha igen, akkor a diák eldobja a tárgyat, és a szoba gázos állapotba kerül.
 */
public class GasStrategy implements ItemUseStrategy {
     ...
     * Ha a megadott feltétel igaz (a camembert zárt), akkor a diák eldobja a tárgyat,
